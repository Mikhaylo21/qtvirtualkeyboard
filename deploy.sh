#!/bin/bash
ip=192.168.2.67
installdir=/home/user/cpp/qtvirtualkeyboard/arm_build/install/
...
install -m 755 -p ./plugins/platforminputcontexts/libqtvirtualkeyboardplugin.so $installdir/plugins/platforminputcontexts/libqtvirtualkeyboardplugin.so

mkdir -p $installdir/lib/cmake/Qt5Gui/ 2> /dev/null
install -m 644 -p /home/user/cpp/qtvirtualkeyboard/arm_build/lib/cmake/Qt5Gui/Qt5Gui_QVirtualKeyboardPlugin.cmake $installdir/lib/cmake/Qt5Gui/Qt5Gui_QVirtualKeyboardPlugin.cmake

mkdir -p $installdir/import/ 2> /dev/null
install -m 644 -p /home/user/cpp/qtvirtualkeyboard/src/virtualkeyboard/import/qmldir $installdir/import/qmldir
install -m 644 -p /home/user/cpp/qtvirtualkeyboard/src/virtualkeyboard/import/plugins.qmltypes $installdir/import/plugins.qmltypes

mkdir -p $installdir/qml/QtQuick/VirtualKeyboard/Styles/ 2> /dev/null
install -m 755 -p ./qml/QtQuick/VirtualKeyboard/Styles/libqtvirtualkeyboardstylesplugin.so $installdir/qml/QtQuick/VirtualKeyboard/Styles/libqtvirtualkeyboardstylesplugin.so

mkdir -p $installdir/styles/ 2> /dev/null
install -m 644 -p /home/user/cpp/qtvirtualkeyboard/src/virtualkeyboard/styles/qmldir $installdir/styles/qmldir
install -m 644 -p /home/user/cpp/qtvirtualkeyboard/src/virtualkeyboard/styles/plugins.qmltypes $installdir/styles/plugins.qmltypes
